...
class InputparamsController {
    ...
    def saveParamsDb()
    {
       ...
       email:inspiretest@gmail.com, sglist:hg19, slist:biocarta_pathway, ld:nearest_tss, filter:2000,
...
*/
        ...
        def dirpath ='/Users/testpatil/Documents/GithubProjects/broaddata/'+outname
        ...
        if(!f.exists())
        {
            ...
            dirpath ='/Users/testpatil/Documents/GithubProjects/broaddata/'+outname+uuid
            f=new File(dirpath);
            f.mkdir();
             outpath=  dirpath
